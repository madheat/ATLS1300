...
# 04102020
"""
This code will generate different triangle art each time it runs all based on my color pallette of yellow
"""
...
def drawTriangles(color):
    ''' draws triangles with random xy points '''
    pygame.draw.polygon(screen, colorList[i%4], [(x1,y1),(x2,y2),(x3,y3)], width) #creates triangles with x,y coordinate points
